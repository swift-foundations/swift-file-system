...
extension File {
    ...
    public struct Directory: Hashable, Sendable {
        ...
        /// Creates a directory by validating a string as a path.
        ///
        /// - Parameter string: The path string to validate.
        /// - Throws: `Paths.Path.Error` if the string is not a valid path.
