...
@testable import File_System_Primitives
    ...
    extension File.System.Async.Test.EdgeCase {
        ...
        private static func canCreateSymlinks(at path: File.Path, fs: File.System.Async) async throws -> Bool {
        ...
        func walkSymlinkCycleNoFollowWindows() async throws {
            try await File.Directory.temporary { dir in
                ...
                guard try await Self.canCreateSymlinks(at: dir.path, fs: fs) else {
