...
final class DirectoryAsyncIterationPerformanceTests {
    ...
    init() throws {
        ...
        self.testDir1000Files = File.Path(tempDir, appending: "perf_async_iter_1000_\(Int.random(in: 0..<Int.max))")
    ...
    func batchSize64() async throws {
        ...
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print("ASYNC BATCH 64: \(totalFiles) files in \(String(format: "%.3f", elapsed * 1000))ms")
    ...
    func batchSize128() async throws {
        ...
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print("ASYNC BATCH 128: \(totalFiles) files in \(String(format: "%.3f", elapsed * 1000))ms")
        print("Per-file: \(String(format: "%.1f", perFileNs)) ns")
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    }
    ...
    func batchSize256() async throws {
        ...
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print("ASYNC BATCH 256: \(totalFiles) files in \(String(format: "%.3f", elapsed * 1000))ms")
        print("Per-file: \(String(format: "%.1f", perFileNs)) ns")
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    }
    ...
    func pullBasedAsyncDefaultBatch() async throws {
        ...
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print("PULL-BASED ASYNC (default batch): \(totalFiles) files in \(String(format: "%.3f", elapsed * 1000))ms")
        print("Per-file: \(String(format: "%.1f", perFileNs)) ns")
